  ...
  <footer className="bg-stone-900 dark:bg-stone-950 text-stone-400 dark:text-stone-500 py-20 px-4 mt-20 border-t border-stone-800">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        {/* Shop */}
        <div className="space-y-4">
          <h4 className="text-white font-semibold font-serif text-lg">Shop</h4>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <input 
              ...
              className="flex-1 px-3 py-2 rounded-lg bg-stone-800 border border-stone-700 text-white text-sm placeholder-stone-600 focus:ring-2 focus:ring-rose-500 outline-none transition-all"
            />
            <button className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-semibold transition-colors duration-300">Subscribe</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-3">
          <div className="bg-stone-800 px-2 py-1 rounded text-white text-[10px] font-bold hover:bg-stone-700 transition-colors cursor-pointer">eSewa</div>
          <div className="bg-stone-800 px-2 py-1 rounded text-white text-[10px] font-bold hover:bg-stone-700 transition-colors cursor-pointer">IME Pay</div>
          <div className="bg-stone-800 px-2 py-1 rounded text-white text-[10px] font-bold hover:bg-stone-700 transition-colors cursor-pointer">Khalti</div>
        </div>
      </div>
    </div>
  </footer>
